...
exports.changePassword = exports.validationChangePassword = void 0;
 ...
 */
exports.validationChangePassword = function (schemas) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, _a = results.errors; _i < _a.length; _i++) {
                        result = _a[_i];
...
exports.changePassword = [
    express_validator_1.body('currentPassword').isString().notEmpty(),
    express_validator_1.body('newPassword').isString().notEmpty().trim(),
    express_validator_1.body('confirmPassword').isString().notEmpty().custom(function (confirmPassword, _a) {
        var req = _a.req;
